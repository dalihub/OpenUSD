...
typedef std::unordered_set<NdrIdentifier, NdrIdentifierHashFunctor>
    NdrIdentifierSet;

// Token
typedef std::vector<TfToken> NdrTokenVec;
typedef std::unordered_map<TfToken, std::string, TfToken::HashFunctor>
    NdrTokenMap;
...
typedef std::unordered_map<TfToken, NdrPropertyConstPtr, TfToken::HashFunctor>
    NdrPropertyPtrMap;
